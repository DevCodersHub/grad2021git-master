...
namespace grad2021.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Branches",
                columns: new[] { "BranchName", "BranchDescription", "CurrentCapacity", "DepartmentName", "FullCapacity", "SelectionStatus" },
                values: new object[,]
                {
                    { "الرياضيات والفيزيقا الهندسية", "وصف قسم الرياضيات والفيزيقا الهندسية", 0, "الرياضيات والفيزيقا الهندسية", 2, 0 },
                    { "هندسة القوى الميكانيكية", "وصف شعبة هندسة القوى الميكانيكية", 0, "الهندسة الميكانيكية", 2, 2 },
                    { "الهندسة الصناعية", "وصف شعبة الهندسة الصناعية", 0, "الهندسة الميكانيكية", 2, 2 },
                    { "هندسة الإنتاج والتصميم الميكانيكي", "وصف شعبة هندسة الإنتاج والتصميم الميكانيكي", 0, "الهندسة الميكانيكية", 2, 2 },
                    { "الهندسة الميكانيكية", "وصف قسم الهندسة الميكانيكية", 0, "الهندسة الميكانيكية", 2, 1 },
                    { "الهندسة المدنية", "وصف قسم الهندسة المدنية", 0, "الهندسة المدنية", 2, 1 },
                    { "هندسة القوى والآلات الكهربية", "وصف شعبة هندسة القوى والآلات الكهربية", 0, "الهندسة الكهربية", 2, 1 },
                    { "هندسة الإلكترونيات والاتصالات الكهربية", "وصف شعبة هندسة الإلكترونيات والاتصالات الكهربية", 0, "الهندسة الكهربية", 2, 1 },
                    { "هندسة الحاسبات والنظم", "وصف شعبة هندسة الحاسبات والنظم", 0, "الهندسة الكهربية", 2, 1 },
                    { "الهندسة المعمارية", "وصف قسم الهندسة المعمارية", 0, "الهندسة المعمارية", 2, 1 }
                });
